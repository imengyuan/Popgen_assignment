...
plot(rep(1: ThisLength, 5), outputa, col = c(rep("red", ThisLength), rep("blue", ThisLength), rep("black", ThisLength), rep("green", ThisLength), rep("orange", ThisLength)), main="a. h=0.5,s=0.1,n=100,p0=0.5", xlab = "Generation", ylab ="Allele frequency")
# b
plot(rep(1: ThisLength, 5), outputb, col = c(rep("red", ThisLength), rep("blue", ThisLength), rep("black", ThisLength), rep("green", ThisLength), rep("orange", ThisLength)), main="b. h=0.5,s=0.1,n=10^6,p0=0.5", xlab = "Generation", ylab ="Allele frequency")
# c
plot(rep(1: ThisLength, 5), outputc, col = c(rep("red", ThisLength), rep("blue", ThisLength), rep("black", ThisLength), rep("green", ThisLength), rep("orange", ThisLength)), main="c. h=0.5,s=0.01,n=100,p0=0.5", xlab = "Generation", ylab ="Allele frequency")
# d
plot(rep(1: ThisLength, 5), outputd, col = c(rep("red", ThisLength), rep("blue", ThisLength), rep("black", ThisLength), rep("green", ThisLength), rep("orange", ThisLength)), main="d. h=0.5,s=0.01,n=10^6,p0=0.5", xlab = "Generation", ylab ="Allele frequency")
# e
plot(rep(1: ThisLength, 5), outpute, col = c(rep("red", ThisLength), rep("blue", ThisLength), rep("black", ThisLength), rep("green", ThisLength), rep("orange", ThisLength)), main="e. h=0.5,s=0.01,n=100,p0=0.05", xlab = "Generation", ylab ="Allele frequency")
# f
plot(rep(1: ThisLength, 5), outputf, col = c(rep("red", ThisLength), rep("blue", ThisLength), rep("black", ThisLength), rep("green", ThisLength), rep("orange", ThisLength)), main="f. h=0.5,s=0.01,n=10^6,p0=0.05", xlab = "Generation", ylab ="Allele frequency")
# g
plot(rep(1: ThisLength, 5), outputg, col = c(rep("red", ThisLength), rep("blue", ThisLength), rep("black", ThisLength), rep("green", ThisLength), rep("orange", ThisLength)), main="g. h=0.5,s=0.01,n=10^6,p0=0.005", xlab = "Generation", ylab ="Allele frequency")
```
